...
class Main_model extends CI_Model
{
	...
	public function get($table_name,$where = NULL,$result = 'row'){
		if($where == NULL){
			...
			file_put_contents('php://stderr', print_r("*****Main Model*"."======", TRUE));
			// file_put_contents('php://stderr', print_r($this->db->get()->result(), TRUE));
			file_put_contents('php://stderr', print_r("*****Main Model*"."======", TRUE));
	...
	public function sendEmail($subject,$to,$message,$type){
		$this->email->from('yourmail@domain.com', $subject);
		$custom ='';
