...
class Drivers extends CI_Controller{
    ...
    public $_table_column_array = ['first_name','last_name','email','password','gender','city','current','address','fcm_token','lat','lng','cover','mobile','status','others','date'];
    public $_table_column_edit = ['id','first_name','last_name','email','password','gender','city','current','address','fcm_token','lat','lng','cover','mobile','status','others','date'];
       ...
       $this->Driver_model->saveUserLogs($saveLogInfo);
        ...
        if($auth && $auth == $this->config->item('encryption_key')){
            ...
            if(isset($data) && !empty($data)){
                ...
                $data = $this->Driver_model->update_password($_POST,$_POST['id']);
                if($data != null){
                    echo $this->json->response($data,$this->_OKmessage,$this->_statusOK);
                }else{
