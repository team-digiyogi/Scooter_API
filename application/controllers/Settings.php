...
class Settings extends CI_Controller{
    ...
    public $_table_column_array = ['currencySymbol','currencySide','appDirection','logo','twillo','creds','delivery'];
    public $_table_column_edit = ['id','currencySymbol','currencySide','appDirection','logo','twillo','creds','delivery'];
    public $required = ['id'];
