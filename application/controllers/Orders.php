...
class Orders extends CI_Controller{
    ...
    public $_table_column_array = ['uid','store_id','date_time','paid_method','order_to','orders','notes','address','driver_id','assignee','total','tax','grand_total','delivery_charge','coupon_code','discount','pay_key','status'];
    public $_table_column_edit = ['id','uid','store_id','date_time','paid_method','order_to','orders','notes','address','driver_id','assignee','total','tax','grand_total','delivery_charge','coupon_code','discount','pay_key','status'];
    public $required = ['id'];
