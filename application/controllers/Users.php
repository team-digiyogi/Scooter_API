...
class Users extends CI_Controller{
    ...
    public $_table_column_array = ['first_name','last_name','email','password','gender','fcm_token','type','lat','lng','cover','mobile','status','verified','others','date','stripe_key'];
    public $_table_column_edit = ['id','first_name','last_name','email','password','gender','fcm_token','type','lat','lng','cover','mobile','status','verified','others','date','stripe_key'];
